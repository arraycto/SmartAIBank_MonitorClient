<template>
  <div class="hallMarket-style">
    ...
    <el-row :gutter="15" v-for="(item,index) in initData" :key="item.waveChartId">
      ...
      <el-col :span="12">
        <div class="wave-content">
          <branch-ranking-chart v-if="hallMarketRankingData && hallMarketRankingData[index] && hallMarketRankingData[index].count!=null" :chart-id="item.branchRankingChartId" :chart-name="item.chartName" :chart-desc="item.chartDesc" :branch-data="hallMarketRankingData[index]"/>
