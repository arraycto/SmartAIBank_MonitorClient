  ...
  <el-row>
    <el-col :span="10">
      <div class="trade-time-bar" style="height:199px">
        <div class="chart-class" style="height:180px" id="privateVipCustomersCicle"></div>
      </div>
    </el-col>
    <el-col :span="14">
      <div class="trade-time-bar" style="height:199px">
        <div class="chart-class" style="height:180px" id="privateVipLineChartChartId"></div>
      </div>
    </el-col>
  </el-row>
</div>
...
export default {
  ...
  methods: {
    initCicleChart (list) {
      if (!(document.getElementById('privateVipCustomersCicle'))) return
      const mChart = echarts.init(document.getElementById('privateVipCustomersCicle'))
      const xLegend = []
      const chartData = []
      // 设置xAxis的值
      var i = 0
    ...
    initLineChart (list) {
      if (!(document.getElementById('privateVipLineChartChartId'))) return
      const mChart = echarts.init(document.getElementById('privateVipLineChartChartId'))
      const xData = []
