    ...
    <el-row>
      <el-col :span="24">
        <div class="trade-time-bar">
          <div class="chart-class" style="height:250px" id="publicBusinessLineChartId"></div>
        </div>
...
export default {
  ...
  methods: {
    initChart (list) {
      if (!(document.getElementById('publicBusinessLineChartId'))) return
      const mChart = echarts.init(document.getElementById('publicBusinessLineChartId'))
      const xData = []
