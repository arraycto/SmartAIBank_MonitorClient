  ...
  <el-row>
    <el-col :span="10">
      <div class="trade-time-bar" style="height:199px">
        <div class="chart-class" style="height:180px" id="publicCustomersCicle"></div>
      </div>
    </el-col>
    <el-col :span="14">
      <div class="trade-time-bar" style="height:199px">
        <div class="chart-class" style="height:180px" id="publicLineChartChartId"></div>
      </div>
    </el-col>
  </el-row>
</div>
...
export default {
  ...
  methods: {
    initCicleChart (list) {
      if (!(document.getElementById('publicCustomersCicle'))) return
      const mChart = echarts.init(document.getElementById('publicCustomersCicle'))
      const xLegend = []
      const chartData = []
      // 设置xAxis的值
      var i = 0
    ...
    initLineChart (list) {
      if (!(document.getElementById('publicLineChartChartId'))) return
      const mChart = echarts.init(document.getElementById('publicLineChartChartId'))
      const xData = []
