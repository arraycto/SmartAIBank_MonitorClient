...
import publicCustChart from '@/syscomponents/smartMonitor/monitor/busyDegree/charts/publicCustChart'
  ...
  methods: {
    ...
    async getData () {
      ...
      try {
        ...
        me.windowID = chartsDatas.companyGatherInfo.windows || []
        me.busyCustGatherInfoInCustType.avgWaitingTime = chartsDatas.companyGatherInfo.busyCustGatherInfoInCustType.avgWaitingTime || 0
        me.busyCustGatherInfoInCustType.waitingCustomers = chartsDatas.companyGatherInfo.busyCustGatherInfoInCustType.waitingCustomers || 0
        me.busyCustGatherInfoInCustType.waitingCustomersRate = chartsDatas.companyGatherInfo.busyCustGatherInfoInCustType.waitingCustomersRate || 0
        me.$set(me.chartsData[0], 'waitTimeRate', parseFloat(chartsDatas.companyGatherInfo.busyWaitTimeDistribution.lessThanTenMinRate || 0).toFixed(2))
        me.$set(me.chartsData[1], 'waitTimeRate', parseFloat(chartsDatas.companyGatherInfo.busyWaitTimeDistribution.betweenTenAndTwentyMinRate || 0).toFixed(2))
        me.$set(me.chartsData[2], 'waitTimeRate', parseFloat(chartsDatas.companyGatherInfo.busyWaitTimeDistribution.betweenTwentyAndThirtyMinRate || 0).toFixed(2))
        me.$set(me.chartsData[3], 'waitTimeRate', parseFloat(chartsDatas.companyGatherInfo.busyWaitTimeDistribution.moreThanThirtyMinRate || 0).toFixed(2))
        me.$set(me.chartsData1[0], 'total', chartsDatas.companyGatherInfo.busyWaitTimeDistribution.totalCount || 0)
        me.$set(me.chartsData[0], 'waitTimeValue', chartsDatas.companyGatherInfo.busyWaitTimeDistribution.lessThanTenMinCount || 0)
        me.$set(me.chartsData[1], 'waitTimeValue', chartsDatas.companyGatherInfo.busyWaitTimeDistribution.betweenTenAndTwentyMinCount || 0)
        me.$set(me.chartsData[2], 'waitTimeValue', chartsDatas.companyGatherInfo.busyWaitTimeDistribution.betweenTwentyAndThirtyMinCount || 0)
        me.$set(me.chartsData[3], 'waitTimeValue', chartsDatas.companyGatherInfo.busyWaitTimeDistribution.moreThanThirtyMinCount || 0)
      } catch (err) {
        this.$message({
          message: err.message,
          type: 'error'
    ...
    async getLineChartData () {
      ...
      try {
        ...
        const startEndTime = await services.api.monitor.monitorBusy.getOrgBusinessHours(this.branchId)
        const chartsDatas = await services.api.monitor.monitorBusy.getPhasedCustomerTypeBusyInfo(this.branchId, 1, startEndTime.endTime, startEndTime.startTime)
        self.timePonitResultDate = chartsDatas.companyGatherInfo.timePhasedBusinessInfoList || []
