<template>
  <div class="satisfactionOrgReport">
      <div class="satisfactionOrgReport-top">
        <el-row  class="satisfactionOrgReport-top-row" style="margin-left:1vw;">
            <el-col :span="5">
                <el-row>
                    <el-col :span="4">
                    <span class="satisfactionOrgReport-top-row-span">机构</span>
                    </el-col>
                    <el-col :span="19">
                    <el-select v-model="branchId" size="mini" placeholder="请选择" class="satisfactionOrgReport-top-row-select"
                    filterable>
                        <el-option
            ...
            <el-col :span="6">
                <el-row>
                    ...
                    <span class="satisfactionOrgReport-top-row-span">报表周期</span>
                    </el-col>
                    <el-col :span="16" :push="4">
                    <el-select v-model="params.reportType" size="mini" placeholder="请选择" class="satisfactionOrgReport-top-row-select">
                        <el-option
            ...
            <el-col :span="9"  v-show="isDay">
                <el-row>
                    ...
                    <span class="satisfactionOrgReport-top-row-span">起止时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                    <el-date-picker
                        v-model="datePicker"
                        class="satisfactionOrgReport-top-row-day"
                        type="daterange"
                        format="yyyyMMdd"
            ...
            <el-col :span="9"  v-show="isMonth">
                <el-row>
                    <el-col :span="3" :push="2">
                      <span class="satisfactionOrgReport-top-row-span">时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                      <el-date-picker
                        v-model="month"
                        class="satisfactionOrgReport-top-row-month"
                        type="month"
                        size="mini"
                        format="yyyy/MM"
            ...
            <el-col :span="9" v-show="isQuarter">
                    ...
                    <el-row>
                        ...
                        <el-col :span="10" :push="5">
                          <el-date-picker
                            ...
                            type="year"
                            size="mini"
                            class="satisfactionOrgReport-top-row-year"
                            format="yyyy"
                            value-format="yyyy"
                ...
                <el-col :span="12">
                    <el-row>
                        ...
                        <span class="satisfactionOrgReport-top-row-span">季度</span>
                        </el-col>
                        <el-col :span="17" :push="3">
                          <el-select v-model="quarterMonth" placeholder="请选择" class="satisfactionOrgReport-top-row-select" size="mini">
                            <!--  -->
                            <el-option
            ...
            <el-col :span="4">
              <el-col :span="14" >
                <el-button type="primary" size="mini" class="satisfactionOrgReport-top-row-btn-query"  @click="checkNull">查&nbsp;&nbsp;询</el-button>
              </el-col>
              <el-col :span="10">
                <tableReport :tableParams="params" :branchId="branchId" class="satisfactionOrgReport-top-row-btn-export" :buttonId="'satisfactionOrgReport'"></tableReport>
              </el-col>
            </el-col>
          </el-row>
      </div>
      <div class="satisfactionOrgReport-bottom">
        <div class="satisfactionOrgReport-bottom-number">
          共{{total}}条记录
        </div>
        <el-table
        :data="tableList"
        ...
        class="satisfactionOrgReport-bottom-table">
          <el-table-column
          :prop="item.prop"
        ...
        <pagination
        class="satisfactionOrgReport-bottom-pagination"
...
export default {
  name: 'satisfactionOrgReportReport',
  data () {
    return {
      dateList: [{
        label: '日报表',
  ...
  methods: {
    ...
    query: async function () {
      try {
        ...
        const data = await services.api.monitor.historyReport.getsatisfactionOrgReportInfo(this.branchId, this.params)
...
.satisfactionOrgReport{
      .el-checkbox{
      margin-right: 1vw !important;
  }
    background-color: transparent;
    height:100%;
  .satisfactionOrgReport-top{
    height:100px;
    background: #FFFFFF;
    box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    border-radius: 8px;
    .satisfactionOrgReport-top-row{
      padding-top:35px;
      .satisfactionOrgReport-top-row-span{
     ...
     .satisfactionOrgReport-top-row-select, .satisfactionOrgReport-top-row-month, .satisfactionOrgReport-top-row-year{
        width:8vw;
      }
      .satisfactionOrgReport-top-row-day{
        width: 15vw;
      }
      .satisfactionOrgReport-top-row-btn-export{
        position: absolute;
        right:1.5rem;
        border-radius: 2px;
     ...
     .satisfactionOrgReport-top-row-btn-query{
        position: absolute;
        right:7rem;
        background: #258AFF;
        border-radius: 2px;
  ...
  .satisfactionOrgReport-center{
      margin-top:2vh;
      .satisfactionOrgReport-center-btn{
        background:#FFF;
        height:10px;
        margin-top:-10px;
        box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    ...
    .satisfactionOrgReport-center-isShow{
      position: relative;
      bottom: 0;
      border:0;
    ...
    .satisfactionOrgReport-center-border{
      transform: rotate(90deg)
    }
  }
  .satisfactionOrgReport-bottom{
    margin-top:0.2vh;
    .satisfactionOrgReport-bottom-number{
    //   margin: 0.3rem;
      font-family: PingFangSC-Regular;
      font-size: 14px;
      color: #4A4A4A;
    ...
    .satisfactionOrgReport-bottom-table{
      margin-top:0.2vh;
      border: 1px solid #DCDBDD;
      box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
      border-radius: 8px;
    }
    .satisfactionOrgReport-bottom-pagination{
      margin-top:3.3vh;
      margin-left:1rem;
    }
  }
