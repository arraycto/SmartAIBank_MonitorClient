<template>
<!--支行视角客户等候时间 -->
  <div class="waittingTimebranchReport">
      <div class="waittingTimebranchReport-top">
        <el-row  class="waittingTimebranchReport-top-row" style="margin-left:1vw;">
            <el-col :span="5">
                <el-row>
                    <el-col :span="4">
                    <span class="waittingTimebranchReport-top-row-span">机构</span>
                    </el-col>
                    <el-col :span="19">
                    <el-select v-model="branchId" size="mini" placeholder="请选择" class="waittingTimebranchReport-top-row-select"
                    filterable>
                        <el-option
            ...
            <el-col :span="6">
                <el-row>
                    ...
                    <span class="waittingTimebranchReport-top-row-span">报表周期</span>
                    </el-col>
                    <el-col :span="16" :push="4">
                    <el-select v-model="params.reportType" size="mini" placeholder="请选择" class="waittingTimebranchReport-top-row-select">
                        <el-option
            ...
            <el-col :span="9"  v-show="isDay">
                <el-row>
                    ...
                    <span class="waittingTimebranchReport-top-row-span">起止时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                    <el-date-picker
                        v-model="datePicker"
                        class="waittingTimebranchReport-top-row-day"
                        type="daterange"
                        format="yyyyMMdd"
            ...
            <el-col :span="9"  v-show="isMonth">
                <el-row>
                    <el-col :span="3" :push="2">
                      <span class="waittingTimebranchReport-top-row-span">时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                      <el-date-picker
                        v-model="month"
                        class="waittingTimebranchReport-top-row-month"
                        type="month"
                        size="mini"
                        format="yyyy/MM"
            ...
            <el-col :span="9" v-show="isQuarter">
                    ...
                    <el-row>
                        ...
                        <el-col :span="10" :push="5">
                          <el-date-picker
                            ...
                            type="year"
                            size="mini"
                            class="waittingTimebranchReport-top-row-year"
                            format="yyyy"
                            value-format="yyyy"
                ...
                <el-col :span="12">
                    <el-row>
                        ...
                        <span class="waittingTimebranchReport-top-row-span">季度</span>
                        </el-col>
                        <el-col :span="17" :push="3">
                          <el-select v-model="quarterMonth" placeholder="请选择" class="waittingTimebranchReport-top-row-select" size="mini">
                            <!--  -->
                            <el-option
            ...
            <el-col :span="4">
              <el-col :span="14" >
                <el-button type="primary" size="mini" class="waittingTimebranchReport-top-row-btn-query"  @click="checkNull">查&nbsp;&nbsp;询</el-button>
              </el-col>
              <el-col :span="10">
                <tableReport :tableParams="params" :branchId="branchId" class="waittingTimebranchReport-top-row-btn-export" :buttonId="'waittingTimebranchReport'"></tableReport>
              </el-col>
            </el-col>
          </el-row>
      </div>
      <div class="waittingTimebranchReport-bottom">
        <div class="waittingTimebranchReport-bottom-number">
          共{{total}}条记录
        </div>
        <el-table
        :data="tableList"
        ...
        class="waittingTimebranchReport-bottom-table">
          <el-table-column
          :prop="item.prop"
        ...
        <pagination
        class="waittingTimebranchReport-bottom-pagination"
...
export default {
  name: 'waittingTimebranchReportReport',
  data () {
    return {
      dateList: [{
        label: '日报表',
  ...
  methods: {
    ...
    query: async function () {
      try {
        // console.log('branchId' + this.branchId + 'params:' + JSON.stringify(this.params)) getTradeTimeBranchInfo
        const data = await services.api.monitor.historyReport.getWaittingTimebranchInfo(this.branchId, this.params)
...
.waittingTimebranchReport{
      .el-checkbox{
      margin-right: 1vw !important;
  }
    background-color: transparent;
    height:100%;
  .waittingTimebranchReport-top{
    height:100px;
    background: #FFFFFF;
    box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    border-radius: 8px;
    .waittingTimebranchReport-top-row{
      padding-top:35px;
      .waittingTimebranchReport-top-row-span{
     ...
     .waittingTimebranchReport-top-row-select, .waittingTimebranchReport-top-row-month, .waittingTimebranchReport-top-row-year{
        width:8vw;
      }
      .waittingTimebranchReport-top-row-day{
        width: 15vw;
      }
      .waittingTimebranchReport-top-row-btn-export{
        position: absolute;
        right:1.5rem;
        border-radius: 2px;
     ...
     .waittingTimebranchReport-top-row-btn-query{
        position: absolute;
        right:7rem;
        background: #258AFF;
        border-radius: 2px;
  ...
  .waittingTimebranchReport-center{
      margin-top:2vh;
      .waittingTimebranchReport-center-btn{
        background:#FFF;
        height:10px;
        margin-top:-10px;
        box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    ...
    .waittingTimebranchReport-center-isShow{
      position: relative;
      bottom: 0;
      border:0;
    ...
    .waittingTimebranchReport-center-border{
      transform: rotate(90deg)
    }
  }
  .waittingTimebranchReport-bottom{
    margin-top:0.2vh;
    .waittingTimebranchReport-bottom-number{
    //   margin: 0.3rem;
      font-family: PingFangSC-Regular;
      font-size: 14px;
      color: #4A4A4A;
    ...
    .waittingTimebranchReport-bottom-table{
      margin-top:0.2vh;
      border: 1px solid #DCDBDD;
      box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
      border-radius: 8px;
    }
    .waittingTimebranchReport-bottom-pagination{
      margin-top:3.3vh;
      margin-left:1rem;
    }
  }
