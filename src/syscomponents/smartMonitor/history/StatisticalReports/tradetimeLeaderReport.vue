<template>
  <div class="tradeTimeLeader">
      <div class="tradeTimeLeader-top">
        <el-row  class="tradeTimeLeader-top-row" style="margin-left:1vw;">
            <el-col :span="5">
                <el-row>
                    <el-col :span="4">
                    <span class="tradeTimeLeader-top-row-span">机构</span>
                    </el-col>
                    <el-col :span="19">
                    <el-select v-model="branchId" size="mini" placeholder="请选择" class="tradeTimeLeader-top-row-select"
                    filterable>
                        <el-option
            ...
            <el-col :span="6">
                <el-row>
                    ...
                    <span class="tradeTimeLeader-top-row-span">报表周期</span>
                    </el-col>
                    <el-col :span="16" :push="4">
                    <el-select v-model="params.reportType" size="mini" placeholder="请选择" class="tradeTimeLeader-top-row-select">
                        <el-option
            ...
            <el-col :span="9"  v-show="isDay">
                <el-row>
                    ...
                    <span class="tradeTimeLeader-top-row-span">起止时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                    <el-date-picker
                        v-model="datePicker"
                        class="tradeTimeLeader-top-row-day"
                        type="daterange"
                        format="yyyyMMdd"
            ...
            <el-col :span="9"  v-show="isMonth">
                <el-row>
                    <el-col :span="3" :push="2">
                      <span class="tradeTimeLeader-top-row-span">时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                      <el-date-picker
                        v-model="month"
                        class="tradeTimeLeader-top-row-month"
                        type="month"
                        size="mini"
                        format="yyyy/MM"
            ...
            <el-col :span="4">
              <el-col :span="14" >
                <el-button type="primary" size="mini" class="tradeTimeLeader-top-row-btn-query"  @click="checkNull">查&nbsp;&nbsp;询</el-button>
              </el-col>
              <el-col :span="10">
                <tableReport :tableParams="params" :branchId="branchId" class="tradeTimeLeader-top-row-btn-export" :buttonId="'tradeTimeLeader'"></tableReport>
              </el-col>
            </el-col>
          </el-row>
      </div>
      <div class="tradeTimeLeader-bottom">
        <div class="tradeTimeLeader-bottom-number">
          共{{total}}条记录
        </div>
        <el-table
        :data="tableList"
        ...
        class="tradeTimeLeader-bottom-table">
          <el-table-column
          :prop="item.prop"
        ...
        <pagination
        class="tradeTimeLeader-bottom-pagination"
  ...
  methods: {
    ...
    query: async function () {
      try {
        ...
        const data = await services.api.monitor.historyReport.gettradetimeLeaderInfo(this.branchId, this.params)
...
.tradeTimeLeader{
  ...
  .tradeTimeLeader-top{
    ...
    border-radius: 8px;
    .tradeTimeLeader-top-row{
      padding-top:35px;
      .tradeTimeLeader-top-row-span{
     ...
     .tradeTimeLeader-top-row-select, .tradeTimeLeader-top-row-month, .tradeTimeLeader-top-row-year{
        width:8vw;
      }
      .tradeTimeLeader-top-row-day{
        width: 15vw;
      }
      .tradeTimeLeader-top-row-btn-export{
        position: absolute;
        right:1.5rem;
        border-radius: 2px;
     ...
     .tradeTimeLeader-top-row-btn-query{
        position: absolute;
        right:7rem;
        background: #258AFF;
        border-radius: 2px;
  ...
  .tradeTimeLeader-center{
      margin-top:2vh;
      .tradeTimeLeader-center-btn{
        background:#FFF;
        height:10px;
        margin-top:-10px;
        box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    ...
    .tradeTimeLeader-center-border{
      transform: rotate(90deg)
    }
  }
  .tradeTimeLeader-bottom{
    margin-top:0.2vh;
    .tradeTimeLeader-bottom-number{
    //   margin: 0.3rem;
      font-family: PingFangSC-Regular;
      font-size: 14px;
      color: #4A4A4A;
    ...
    .tradeTimeLeader-bottom-table{
      margin-top:0.2vh;
      border: 1px solid #DCDBDD;
      box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
      border-radius: 8px;
    }
    .tradeTimeLeader-bottom-pagination{
      margin-top:3.3vh;
      margin-left:1rem;
    }
  }
