<template>
  <div class="tradetimeZHReport">
      <div class="tradetimeZHReport-top">
        <el-row  class="tradetimeZHReport-top-row" style="margin-left:1vw;">
            <el-col :span="5">
                <el-row>
                    <el-col :span="4">
                    <span class="tradetimeZHReport-top-row-span">机构</span>
                    </el-col>
                    <el-col :span="19">
                    <el-select v-model="branchId" size="mini" placeholder="请选择" class="tradetimeZHReport-top-row-select"
                    filterable>
                        <el-option
            ...
            <el-col :span="6">
                <el-row>
                    ...
                    <span class="tradetimeZHReport-top-row-span">报表周期</span>
                    </el-col>
                    <el-col :span="16" :push="4">
                    <el-select v-model="params.reportType" size="mini" placeholder="请选择" class="tradetimeZHReport-top-row-select">
                        <el-option
            ...
            <el-col :span="9"  v-show="isDay">
                <el-row>
                    ...
                    <span class="tradetimeZHReport-top-row-span">起止时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                    <el-date-picker
                        v-model="datePicker"
                        class="tradetimeZHReport-top-row-day"
                        type="daterange"
                        format="yyyyMMdd"
            ...
            <el-col :span="9"  v-show="isMonth">
                <el-row>
                    <el-col :span="3" :push="2">
                      <span class="tradetimeZHReport-top-row-span">时间</span>
                    </el-col>
                    <el-col :span="18" :push="2">
                      <el-date-picker
                        v-model="month"
                        class="tradetimeZHReport-top-row-month"
                        type="month"
                        size="mini"
                        format="yyyy/MM"
            ...
            <el-col :span="4">
              <el-col :span="14" >
                <el-button type="primary" size="mini" class="tradetimeZHReport-top-row-btn-query"  @click="checkNull">查&nbsp;&nbsp;询</el-button>
              </el-col>
              <el-col :span="10">
                <tableReport :tableParams="params" :branchId="branchId" class="tradetimeZHReport-top-row-btn-export" :buttonId="'tradeTimeZH'"></tableReport>
              </el-col>
            </el-col>
          </el-row>
      </div>
      <div class="tradetimeZHReport-bottom">
        <div class="tradetimeZHReport-bottom-number">
          共{{total}}条记录
        </div>
        <el-table
        :data="tableList"
        ...
        class="tradetimeZHReport-bottom-table">
          <el-table-column
          :prop="item.prop"
        ...
        <pagination
        class="tradetimeZHReport-bottom-pagination"
  ...
  methods: {
    ...
    query: async function () {
      try {
        ...
        const data = await services.api.monitor.historyReport.gettradetimeZHInfo(this.branchId, this.params)
...
.tradetimeZHReport{
    ...
    height:100%;
  .tradetimeZHReport-top{
    height:100px;
    background: #FFFFFF;
    box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    border-radius: 8px;
    .tradetimeZHReport-top-row{
      padding-top:35px;
      .tradetimeZHReport-top-row-span{
     ...
     .tradetimeZHReport-top-row-select, .tradetimeZHReport-top-row-month, .tradetimeZHReport-top-row-year{
        width:8vw;
      }
      .tradetimeZHReport-top-row-day{
        width: 15vw;
      }
      .tradetimeZHReport-top-row-btn-export{
        position: absolute;
        right:1.5rem;
        border-radius: 2px;
     ...
     .tradetimeZHReport-top-row-btn-query{
        position: absolute;
        right:7rem;
        background: #258AFF;
        border-radius: 2px;
  ...
  .tradetimeZHReport-center{
      margin-top:2vh;
      .tradetimeZHReport-center-btn{
        background:#FFF;
        height:10px;
        margin-top:-10px;
        box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
    ...
    .tradetimeZHReport-center-isShow{
      position: relative;
      bottom: 0;
      border:0;
    ...
    .tradetimeZHReport-center-border{
      transform: rotate(90deg)
    }
  }
  .tradetimeZHReport-bottom{
    margin-top:0.2vh;
    .tradetimeZHReport-bottom-number{
    //   margin: 0.3rem;
      font-family: PingFangSC-Regular;
      font-size: 14px;
      color: #4A4A4A;
    ...
    .tradetimeZHReport-bottom-table{
      margin-top:0.2vh;
      border: 1px solid #DCDBDD;
      box-shadow: 0 5px 10px 0 rgba(225,226,230,0.50);
      border-radius: 8px;
    }
    .tradetimeZHReport-bottom-pagination{
      margin-top:3.3vh;
      margin-left:1rem;
    }
  }
