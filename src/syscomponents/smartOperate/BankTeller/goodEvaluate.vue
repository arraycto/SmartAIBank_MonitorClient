 <template>
  <div class="good-evaluate-content">
    <bar-ranking-chart chart-id="goodEvaluateId"
                       chart-title="好评率"
        ...
        <el-col :span="12">
          <div class="item-temple">
            <teller-handle-time-chart v-if="null!=item[0]"
                                      :chart-data="item[0]"
                                      :chart-id="'goodEvaluate0'+index"
                                      chart-type="good"></teller-handle-time-chart>
          </div>
        </el-col>
        <el-col :span="12"
