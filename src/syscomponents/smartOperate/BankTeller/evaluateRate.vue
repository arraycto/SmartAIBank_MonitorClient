 <template>
  <div class="evaluate-rate-content">
    <bar-ranking-chart chart-id="evaluateRateId"
                       chart-title="评价率"
        ...
        <el-col :span="12">
          <div class="item-temple">
            <teller-handle-time-chart v-if="null!=item[0]"
                                      :chart-data="item[0]"
                                      :chart-id="'evaluateRate0'+index"
                                      chart-type="evaluate"></teller-handle-time-chart>
          </div>
        </el-col>
        <el-col :span="12"
...
.evaluate-rate-content {
  ...
  .item-temple:hover {
    ...
    border-radius: 4px;
    padding: 10px;
    box-shadow: 5px 5px 10px #3a8ee6;
  }
}
</style>
