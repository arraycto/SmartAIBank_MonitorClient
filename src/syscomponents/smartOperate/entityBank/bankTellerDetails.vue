        ...
        <el-row :gutter="15">
          <el-col :span="12">
            <div class="item-module-style">
              <details-module-chart chart-id="tellerTradeNumId" chart-type="number" :chart-data="tranCountDistributionList" v-if="null!=tranCountDistributionList"/>
...
export default {
  ...
  watch: {
    ...
    '$store.state.orgId': function (newValue, oldValue) {
      this.$store.dispatch('delView', currRouter).then(({ visitedViews }) => {
