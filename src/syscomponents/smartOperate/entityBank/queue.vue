    ...
    <el-row :gutter="15">
      <el-col :span="8" v-for="(item, index) in queueTimeByCustTypeList" :key="index">
        <div class="custerm-type-content">
          <customer-type-chart :line-chart-id="'entityCustomerLineChartId'+index" :circle-chart-id="'entityCustomerCircleChartId'+index" :customer-data="item"/>
        </div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="24">
        <div class="entity-content">
          <time-frame-chart chart-id="entityTimeFrameId" :chart-data="queueTimeDomainList"/>
        </div>
      </el-col>
    </el-row>
  </div>
...
export default {
  ...
  components: {
    monthChart, minuteChart, customerTypeChart, timeFrameChart, timeSelect
  },
  mounted () {
