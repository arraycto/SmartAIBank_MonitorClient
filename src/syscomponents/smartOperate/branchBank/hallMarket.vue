<template>
  <div class="hallMarket-style">
    ...
    <el-row :gutter="15" v-for="(item,index) in initData" :key="item.waveChartId">
      ...
      <el-col :span="12">
        <div class="wave-content">
          <branch-ranking-chart v-if="hallMarketRankingData[index] !=null" :chart-id="item.branchRankingChartId" :chart-desc="item.chartDesc" :chart-name="item.chartName"  :branch-data="hallMarketRankingData[index]"/>
